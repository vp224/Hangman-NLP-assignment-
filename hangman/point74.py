...
def guess_word(maskedWord, guesses):
    ...
    for i in range(0,len(maskedWord)):
        ...
        for j in range(index,i+1):
            for l in range(1,5) :
                if j+l <= jndex and j+l >= i and j+l < len(maskedWord):
                    if '[' not in maskedWord[j:j+l] and ']' not in maskedWord[j:j+l] :
                        if l == 1 and len(find('_', maskedWord[j:j+l])) == 1:
                            ...
                            for x in letters:
                                if 2*temp[x] > prob[x]:
                                    prob[x] = 2*temp[x]
                        if l == 2 and len(find('_', maskedWord[j:j+l])) < 2:
                            ...
                            for x in letters:
                                if 3*temp[x] > prob[x]:
                                    prob[x] = 3*temp[x]
                        if l == 3 and len(find('_', maskedWord[j:j+l])) < 2:
                        ...
                        if l == 4 and len(find('_', maskedWord[j:j+l])) < 2:
